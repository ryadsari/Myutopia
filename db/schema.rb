...
ActiveRecord::Schema.define(version: 2022_05_31_085829) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.index ["character_id"], name: "index_chatrooms_on_character_id"
  end
  ...
  create_table "worlds", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["character_id"], name: "index_worlds_on_character_id"
    t.index ["chatroom_id"], name: "index_worlds_on_chatroom_id"
  end
